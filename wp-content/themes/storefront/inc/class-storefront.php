...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
			...
			// Add custom css styles to the theme - jpraychev
			wp_enqueue_style( 'jpraychev-styles', get_template_directory_uri() . '/assets/css/base/jpraychev.css', '', $storefront_version );
			wp_style_add_data( 'jpraychev-styles', 'rtl', 'replace' );
